      ...
      <Layout seo={layoutProps.seo}>
        <main className="prose mx-auto prose-headings:font-display lg:prose-xl">
          ...
          <p>
            ...
            about tech (tools I use or I have discovered) and my hobbies.
            Creating and maintaining this website is also a way for me to
            improve my skills with ReactJS, a library that I love!
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              (Just in case you want to share some theories about Attack On
              Titan)
            </li>
          </ul>
        </main>
