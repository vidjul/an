...
const Header = () => {
  ...
  return (
    <header ref={ref} className="sticky top-0 z-10 bg-white px-4 py-8 font-display text-xl shadow-xs md:px-16">
      <span>vidu.sh</span>
      <Breadcrumbs />
      {showCursor &&<span className="animate-[blink_1s_step-end_infinite]">_</span>}
    </header>
  );
};
